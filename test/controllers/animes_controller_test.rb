...
class AnimesControllerTest < ActionDispatch::IntegrationTest
  ...
  test "should create anime" do
    assert_difference('Anime.count') do
      post animes_url, params: { anime: { body: @anime.body, description: @anime.description, image: @anime.image, name: @anime.name } }
    end
  ...
  test "should update anime" do
    patch anime_url(@anime), params: { anime: { body: @anime.body, description: @anime.description, image: @anime.image, name: @anime.name } }
